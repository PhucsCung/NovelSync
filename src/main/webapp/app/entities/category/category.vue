<template>
  <div>
    <h2 id="page-heading" data-cy="CategoryHeading">
      <span v-text="t$('novelsyncApp.category.home.title')" id="category-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('novelsyncApp.category.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'CategoryCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('novelsyncApp.category.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && categories && categories.length === 0">
      <span v-text="t$('novelsyncApp.category.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="categories">
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('categoryName')">
              <span v-text="t$('novelsyncApp.category.categoryName')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="novelsyncApp.category.delete.question" data-cy="categoryDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-category-heading" v-text="t$('novelsyncApp.category.delete.question', { id: removeId })"></p>
      </div>
