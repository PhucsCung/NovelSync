...
public class OrderDetailResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<OrderDetail> createOrderDetail(@Valid @RequestBody OrderDetail orderDetail) throws URISyntaxException {
    ...
    public ResponseEntity<OrderDetail> partialUpdateOrderDetail(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody OrderDetail orderDetail
    ) throws URISyntaxException {
    ...
    public ResponseEntity<List<OrderDetail>> getAllOrderDetails(
        ...
        if (eagerload) {
            page = orderDetailService.findAllWithEagerRelationships(pageable);
        } else {
