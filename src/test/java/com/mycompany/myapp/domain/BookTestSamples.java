...
public class BookTestSamples {
    ...
    public static Book getBookSample1() {
        return new Book().id(1L).title("title1").isbn("isbn1").stockQuantity(1).imageUrl("imageUrl1");
    }

    public static Book getBookSample2() {
        return new Book().id(2L).title("title2").isbn("isbn2").stockQuantity(2).imageUrl("imageUrl2");
    }
