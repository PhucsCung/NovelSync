...
describe('Service Tests', () => {
  describe('Book Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Book(123, 'AAAAAAA', 'AAAAAAA', 0, 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Book', async () => {
        const returnedFromService = { title: 'BBBBBB', isbn: 'BBBBBB', price: 1, stockQuantity: 1, imageUrl: 'BBBBBB', ...elemDefault };
      ...
      it('should partial update a Book', async () => {
        const patchObject = { title: 'BBBBBB', isbn: 'BBBBBB', stockQuantity: 1, imageUrl: 'BBBBBB', ...new Book() };
