...
class CustomerResourceIT {
    ...
    public static Customer createEntity() {
        return new Customer().fullName(DEFAULT_FULL_NAME).phoneNumber(DEFAULT_PHONE_NUMBER);
    }
    ...
    public static Customer createUpdatedEntity() {
        return new Customer().fullName(UPDATED_FULL_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.fullName(UPDATED_FULL_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.fullName(UPDATED_FULL_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
