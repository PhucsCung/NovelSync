...
class AuthorResourceIT {
    ...
    public static Author createEntity() {
        return new Author().authorName(DEFAULT_AUTHOR_NAME);
    }
    ...
    public static Author createUpdatedEntity() {
        return new Author().authorName(UPDATED_AUTHOR_NAME);
    }
    ...
    void putExistingAuthor() throws Exception {
        ...
        updatedAuthor.authorName(UPDATED_AUTHOR_NAME);
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.authorName(UPDATED_AUTHOR_NAME);
