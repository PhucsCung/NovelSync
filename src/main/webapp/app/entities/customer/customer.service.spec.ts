...
describe('Service Tests', () => {
  describe('Customer Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Customer(123, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Customer', async () => {
        const returnedFromService = { fullName: 'BBBBBB', phoneNumber: 'BBBBBB', ...elemDefault };
      ...
      it('should partial update a Customer', async () => {
        const patchObject = { fullName: 'BBBBBB', ...new Customer() };
